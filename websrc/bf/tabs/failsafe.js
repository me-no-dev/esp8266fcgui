...
TABS.failsafe.initialize = function (callback, scrollPosition) {
    ...
    function process_html() {
        ...
        if (apiVersionGte1_15_0) {
            ...
            var channelNames = [
                    getLocalizedMessage('controlAxisRoll'),
                    getLocalizedMessage('controlAxisPitch'),
                    getLocalizedMessage('controlAxisYaw'),
                    getLocalizedMessage('controlAxisThrottle')
                ],
                ...
                if (i < channelNames.length) {
                    fullChannels_e.append('\
                        <div class="number">\
                            ...
                            <div class="cf_tip channelsetting" title="' + getLocalizedMessage("failsafeChannelFallbackSettingsAuto") + '">\
                    ...
                    fullChannels_e.append('\
                        <div class="number">\
                            <div class="channelauxiliary">\
                                <span class="channelname">' + getLocalizedMessage("controlAxisAux" + (aux_index++)) + '</span>\
                                ' + auxAssignment[aux_assignment_index++] + '\
                            </div>\
                            <div class="cf_tip channelsetting" title="' + getLocalizedMessage("failsafeChannelFallbackSettingsHold") + '">\
                                <select class="aux_set" id="' + i + '">\
                                    <option value="1">Hold</option>\
        ...
        $('a.save').click(function () {
            ...
            function reboot() {
                GUI.log(getLocalizedMessage('configurationEepromSaved'));
            ...
            function reinitialize() {
                GUI.log(getLocalizedMessage('deviceRebooting'));
                ...
                if (BOARD.find_board_definition(CONFIG.boardIdentifier).vcp) { // VCP-based flight controls may crash old drivers, we catch and reconnect
                    ...
                    GUI.timeout_add('waiting_for_bootup', function waiting_for_bootup() {
                        MSP.send_message(MSPCodes.MSP_STATUS, false, false, function() {
                            GUI.log(getLocalizedMessage('deviceReady'));
