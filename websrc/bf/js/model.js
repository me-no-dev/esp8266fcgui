...
var mixerList = [
    ...
    {name: 'Quad +',           model: 'custom',     image: 'custom'},
    {name: 'Quad X',           model: 'quad_x',     image: 'quad_x'},
    {name: 'Bicopter',         model: 'custom',     image: 'custom'},
    {name: 'Gimbal',           model: 'custom',     image: 'custom'},
    {name: 'Y6',               model: 'custom',     image: 'custom'},
    {name: 'Hex +',            model: 'custom',     image: 'custom'},
    {name: 'Flying Wing',      model: 'custom',     image: 'custom'},
    {name: 'Y4',               model: 'custom',     image: 'custom'},
    {name: 'Hex X',            model: 'custom',     image: 'custom'},
    {name: 'Octo X8',          model: 'custom',     image: 'custom'},
    {name: 'Octo Flat +',      model: 'custom',     image: 'custom'},
    {name: 'Octo Flat X',      model: 'custom',     image: 'custom'},
    {name: 'Airplane',         model: 'custom',     image: 'custom'},
    {name: 'Heli 120',         model: 'custom',     image: 'custom'},
    {name: 'Heli 90',          model: 'custom',     image: 'custom'},
    {name: 'V-tail Quad',      model: 'custom',     image: 'custom'},
    ...
    {name: 'A-tail Quad',      model: 'custom',     image: 'custom'},
...
Model.prototype.loadJSON = function (model_file, callback) {
    ...
    loader.load('models/' + model_file + '.json', function (geometry, materials) {
